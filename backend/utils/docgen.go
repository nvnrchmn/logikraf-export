...
func header(pdf *fpdf.Fpdf, d DocData, title string) {
	...
	pdf.CellFormat(90, 8, SellerName, "", 0, "L", false, 0, "")
	pdf.SetFont("DVS-B", "", 12)
	pdf.CellFormat(90, 8, title, "", 1, "R", false, 0, "")
	pdf.SetFont("DVS", "", 8)
	pdf.SetTextColor(100, 116, 139)
	pdf.CellFormat(90, 5, SellerAddress, "", 0, "L", false, 0, "")
	pdf.CellFormat(90, 5, "No. "+d.DocNo, "", 1, "R", false, 0, "")
	pdf.CellFormat(90, 5, SellerTaxID, "", 0, "L", false, 0, "")
...
func signatureBlock(pdf *fpdf.Fpdf) {
	pdf.Ln(14)
	pdf.SetFont("DVS", "", 8)
	pdf.CellFormat(0, 5, "For and on behalf of "+SellerName, "", 1, "R", false, 0, "")
	pdf.Ln(10)
	pdf.SetFont("DVS", "", 9)
...
func pebSheet(pdf *fpdf.Fpdf, d DocData) {
	...
	rows := [][2]string{
		{"Eksportir", SellerName + " — " + SellerAddress},
		{"Consignee / Buyer", o.Buyer.CompanyName + " — " + o.Buyer.City + ", " + o.Buyer.Country},
		{"Pelabuhan Muat", o.PortLoading.Name + " (" + o.PortLoading.Code + ")"},
		{"Pelabuhan Bongkar", o.PortDischarge.Name + " (" + o.PortDischarge.Code + ")"},
